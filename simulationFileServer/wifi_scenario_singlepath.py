...
def topology(args, server_cmd, client_cmd):
    ...
    net.addLink(h1, s1, intfName2='s1-eth1', params2={'ip': '10.0.0.1/24'}, bw=100)

    net.addLink(ap1, r0, intfName1='ap1-eth2', intfName2='r0-eth1', params2={'ip': '192.168.2.2/24'},bw=100)

    net.addLink(s1, r0, intfName1='s1-eth2', intfName2='r0-eth2', params1={'ip': '10.0.1.1/24'}, params2={'ip': '10.0.1.2/24'},bw=100)
